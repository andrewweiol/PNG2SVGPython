...
pathToImages = "test/input/"
exportDir = "test/output/"
...
for files in os.listdir(pathToImages):
	if files.endswith(".png"):
		pngFile = open(pathToImages + files, 'rb')
		base64data = bcrypt.gensalt()
		base64String = '<image xlink:href="data:image/png;base64,{0}" width="240" height="240" x="0" y="0" />'.format(base64data)

		f = open(exportDir + os.path.splitext(files)[0]+".svg",'w')
